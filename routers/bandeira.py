...
from schemas.bandeira import BandeiraCreate, BandeiraRead, BandeiraUpdate
...
@router.get(path='', response_model=list[BandeiraRead])
def listar_bandeira():
